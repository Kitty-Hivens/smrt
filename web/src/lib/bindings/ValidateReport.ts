 ...
 */
export type ValidateReport = { archive_mod_count: number, declared_mods: number, declared_assets: number, matched: number, missing_in_config: Array<string>, extra_in_config: Array<string>, };
