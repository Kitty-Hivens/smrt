...
export const ru: Dict = {
  ...
  'resolve.loaderUnverified': 'через мост: {n}',
  'resolve.loaderMismatchH': 'Собран под загрузчик, которого в паке нет, и мостить нечем (не загрузится)',
  'resolve.loaderUnverifiedH': 'Мод другого загрузчика, тянет коннектор -- он везёт одни моды и не везёт другие, поэтому вердикта нет',
  'resolve.builtFor': 'собран под {loaders}; пак на {pack}',
  'resolve.bridgedBy': 'мод для {loaders}, мостит {by}',
