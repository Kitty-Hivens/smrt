...
export const en = {
  ...
  'pe.spoof.asked': 'Asked {where}: it advertises {n} mods.',
  ...
  'pe.valExtra': '{n} extra',
  'pe.valArchiveMods': 'Archive: {n} mods',
  ...
  'resolve.mixinGaps': '{n} missing mixin target',
  ...
  'resolve.loaderWindow': '{n} loader build',
  ...
  'thr.comments': '{n} comment(s)',
  'thr.back': 'back to the pack',
  'thr.offers': 'What it offers',
  'thr.offersLead': 'Taking it writes {add} arrival(s), {remove} departure(s) and {change} change(s) into this pack.',
  ...
  'thr.reply': 'Reply',
  'thr.merge': 'Take it',
  'thr.mergeAsk': 'Write {add} arrival(s), {remove} departure(s) and {change} change(s) into this pack, as a commit?',
  ...
  'hist.restoreEffect': 'It writes {add} arrival(s), {remove} departure(s) and {change} change(s) onto what is there now, as a new commit.',
