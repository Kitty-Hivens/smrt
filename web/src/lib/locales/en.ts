...
export const en = {
  ...
  'resolve.loaderUnverified': '{n} bridged',
  'resolve.loaderMismatchH': 'Built for a loader this pack does not run, with nothing to bridge it (it will not load)',
  'resolve.loaderUnverifiedH': 'Another loader\'s mod, carried by a connector -- a connector runs some and not others, so this is not judged either way',
  'resolve.builtFor': 'built for {loaders}; this pack is {pack}',
  'resolve.bridgedBy': '{loaders} mod, bridged by {by}',
