...
export const en = {
  ...
  'cur.rawHint': 'Full-fidelity TOML — every comment kept verbatim. The omnibus file: default_off, mark_optional, incompatible, substitute, role_table, category_table, extra_mods/assets, drop_assets, hidemymods.',
  ...
  'cur.modsN': '{n} mods',
  'cur.col.mod': 'mod',
  'cur.col.optional': 'optional',
  'cur.col.defaultOff': 'default-off',
